...
export const ROOMS = {
  A: { name: 'CRYO-MAINTENANCE', x0: 3, z0: 36, x1: 12, z1: 43, floor: 'plate', wall: 'panel' },
  B: { name: 'CORRIDOR W-2', x0: 14, z0: 18, x1: 15, z1: 45, floor: 'grate', wall: 'panel' },
  C: { name: 'QUIET ROOM', x0: 7, z0: 20, x1: 12, z1: 25, floor: 'carpet', wall: 'wood', safe: true },
  J: { name: 'POWER RELAY', x0: 4, z0: 28, x1: 12, z1: 33, floor: 'grate', wall: 'concrete' },
  G: { name: 'CENTRAL CONCOURSE', x0: 17, z0: 30, x1: 44, z1: 31, floor: 'plate', wall: 'panel' },
  D: { name: 'CREW QUARTERS', x0: 18, z0: 22, x1: 26, z1: 28, floor: 'plate', wall: 'panel' },
  H: { name: 'SECURITY', x0: 30, z0: 22, x1: 36, z1: 28, floor: 'concrete', wall: 'concrete' },
  E: { name: 'MESS HALL', x0: 18, z0: 33, x1: 28, z1: 41, floor: 'tile', wall: 'panel' },
  F: { name: 'MEDICAL BAY', x0: 31, z0: 33, x1: 38, z1: 39, floor: 'tile', wall: 'medical' },
  K: { name: 'CORRIDOR E-1', x0: 46, z0: 8, x1: 47, z1: 44, floor: 'grate', wall: 'panel' },
  L: { name: 'OBSERVATION DECK', x0: 49, z0: 16, x1: 60, z1: 22, floor: 'carpet', wall: 'panel', window: true },
  I: { name: 'ARCHIVE', x0: 49, z0: 25, x1: 57, z1: 33, floor: 'carpet', wall: 'wood' },
  N: { name: 'QUIET ROOM', x0: 49, z0: 36, x1: 54, z1: 40, floor: 'carpet', wall: 'wood', safe: true },
  M: { name: 'COMMUNICATIONS ARRAY', x0: 41, z0: 1, x1: 52, z1: 6, floor: 'grate', wall: 'concrete' },
};
...
// reddish) | 'main' (only after power restored).
export const LIGHTS = [
  // Cryo
  { room: 'A', x: 6, z: 38.5, color: 0x7fc8d0, i: 2.2, d: 7, flicker: 0.05 },
  { room: 'A', x: 10.5, z: 40, color: 0x9fd6dc, i: 2.4, d: 8, flicker: 0.02 },
  { room: 'A', x: 12.3, z: 39.2, y: 2.3, color: 0xff2020, i: 1.2, d: 4, pulse: 1.2 },
  // West corridor
  { room: 'B', x: 15, z: 21, color: 0xd8d0b8, i: 1.4, d: 6, flicker: 0.3 },
  { room: 'B', x: 15, z: 28, color: 0xd8d0b8, i: 1.6, d: 6, flicker: 0.02 },
  { room: 'B', x: 15, z: 35, color: 0xd8d0b8, i: 1.3, d: 6, flicker: 0.5 },
  { room: 'B', x: 15, z: 42, color: 0xff3030, i: 1.1, d: 5, pulse: 0.7 },
  // Quiet room — warm and red
  { room: 'C', x: 10, z: 21.2, y: 1.2, color: 0xff3a2a, i: 2.6, d: 6 },
  { room: 'C', x: 8.5, z: 24, y: 1.6, color: 0xffa060, i: 1.2, d: 5 },
  // Relay
  { room: 'J', x: 8, z: 30, color: 0xff2a1a, i: 1.6, d: 7, pulse: 0.5, power: 'emergency' },
  { room: 'J', x: 6, z: 30.5, color: 0xcfe6ff, i: 2.4, d: 8, power: 'main' },
  { room: 'J', x: 11, z: 32, color: 0xcfe6ff, i: 1.8, d: 7, power: 'main', flicker: 0.05 },
  // Concourse
  { room: 'G', x: 20, z: 31, color: 0xff2a20, i: 1.6, d: 7, pulse: 0.6, power: 'emergency' },
  { room: 'G', x: 28, z: 31, color: 0xff2a20, i: 1.4, d: 7, pulse: 0.6, power: 'emergency' },
  { room: 'G', x: 36, z: 31, color: 0xff2a20, i: 1.4, d: 7, pulse: 0.6, power: 'emergency' },
  { room: 'G', x: 43, z: 31, color: 0xff2a20, i: 1.2, d: 6, pulse: 0.6, power: 'emergency' },
  { room: 'G', x: 22, z: 31, color: 0xd8e4e4, i: 1.8, d: 7, power: 'main', flicker: 0.02 },
  { room: 'G', x: 32, z: 31, color: 0xd8e4e4, i: 1.8, d: 7, power: 'main', flicker: 0.2 },
  { room: 'G', x: 41, z: 31, color: 0xd8e4e4, i: 1.8, d: 7, power: 'main' },
  // Crew quarters
  ...
  { room: 'H', x: 34, z: 26, color: 0xd0d6d8, i: 1.4, d: 7, flicker: 0.4 },
  // Mess
  ...
  // Medical
  { room: 'F', x: 34.5, z: 36, color: 0xc8ffff, i: 2.6, d: 8, power: 'main', flicker: 0.05 },
  ...
  // Observation — planet light through the window
  { room: 'L', x: 55, z: 17.5, y: 2.0, color: 0xffd8a8, i: 3.0, d: 11 },
  { room: 'L', x: 51, z: 21, color: 0x8090a0, i: 0.8, d: 6 },
  // Archive
  { room: 'I', x: 53.5, z: 31, y: 1.3, color: 0xffc080, i: 2.0, d: 6, flicker: 0.03 },
  { room: 'I', x: 52, z: 27, color: 0xa08870, i: 1.0, d: 7, flicker: 0.4 },
  // Quiet room 2
  { room: 'N', x: 51.5, z: 36.8, y: 1.2, color: 0xff3a2a, i: 2.6, d: 6 },
  { room: 'N', x: 53, z: 39.5, y: 1.6, color: 0xffa060, i: 1.0, d: 5 },
  // Comms
...
export const PROPS = [
  ...
  { room: 'A', t: 'locker', x: 3.3, z: 39.2, r: 1 },
  { room: 'A', t: 'locker', x: 3.3, z: 40.1, r: 1 },
  { room: 'A', t: 'locker', x: 3.3, z: 41.0, r: 1, open: true },
  { room: 'A', t: 'breaker', x: 12.95, z: 41.2, r: 3 },
  { room: 'A', t: 'crate', x: 12.1, z: 43.1, s: 0.8 },
  { room: 'A', t: 'crate', x: 11.3, z: 43.3, s: 0.6 },
  { room: 'A', t: 'decal', x: 8, z: 40.5, kind: 'oil', s: 2.2 },
  { room: 'A', t: 'sign', x: 8, z: 36.02, y: 2.35, text: 'CRYO-MAINT.', r: 0 },
  ...
  { room: 'B', t: 'poster', x: 15.98, z: 26.5, r: 3, kind: 0 },
  { room: 'B', t: 'poster', x: 15.98, z: 36.5, r: 3, kind: 1 },
  { room: 'B', t: 'body', x: 14.8, z: 44.4, rot: 2.4 },
  { room: 'B', t: 'decal', x: 15, z: 44.2, kind: 'blood', s: 1.8 },
  { room: 'B', t: 'decal', x: 14.8, z: 33, kind: 'oil', s: 1.2 },
  { room: 'B', t: 'sign', x: 15, z: 18.02, y: 2.3, text: 'NO ACCESS', r: 0, red: true },

  // ---------- C: Quiet room ----------
  { room: 'C', t: 'saveTerminal', x: 10, z: 20.35, r: 0 },
  { room: 'C', t: 'trunk', x: 8.1, z: 20.7, r: 0 },
  ...
  { room: 'C', t: 'poster', x: 7.02, z: 21.5, r: 1, kind: 2 },
  ...
  { room: 'J', t: 'sign', x: 8.5, z: 28.02, y: 2.35, text: 'HIGH VOLTAGE', r: 0, red: true },
  ...
  { room: 'G', t: 'poster', x: 37, z: 30.02, r: 0, kind: 2 },
  { room: 'G', t: 'sign', x: 20, z: 30.02, y: 2.3, text: 'DECK 2 / HAB', r: 0 },
  ...
  { room: 'D', t: 'locker', x: 26.7, z: 25.0, r: 3 },
  { room: 'D', t: 'locker', x: 26.7, z: 25.9, r: 3 },
  { room: 'D', t: 'locker', x: 26.7, z: 26.8, r: 3 },
  ...
  { room: 'D', t: 'poster', x: 18.02, z: 26, r: 1, kind: 0 },

  // ---------- H: Security ----------
  { room: 'H', t: 'desk', x: 33, z: 22.7, r: 0, w: 3.2 },
  { room: 'H', t: 'monitorBank', x: 33, z: 22.25, r: 0 },
  { room: 'H', t: 'chair', x: 33, z: 23.8, r: 2 },
  { room: 'H', t: 'cabinet', x: 30.35, z: 24, r: 1 },
  { room: 'H', t: 'cabinet', x: 30.35, z: 25, r: 1 },
  { room: 'H', t: 'rack', x: 36.7, z: 25.5, r: 3 },
  ...
  { room: 'E', t: 'counter', x: 28.55, z: 35.5, len: 4, r: 3 },
  ...
  { room: 'E', t: 'poster', x: 23, z: 33.02, r: 0, kind: 1 },
  { room: 'E', t: 'sign', x: 26.5, z: 33.02, y: 2.3, text: 'RATIONS', r: 0 },
  ...
  { room: 'F', t: 'desk', x: 37.8, z: 38.8, r: 3 },
  { room: 'F', t: 'terminal', x: 38, z: 38.8, y: 0.78, r: 3, lines: ['MED-SYS', 'PATIENT W3', 'WIPES: 14'], color: [120, 220, 255] },
  { room: 'F', t: 'decal', x: 35, z: 37.5, kind: 'blood', s: 2 },

  // ---------- K: East corridor ----------
  { room: 'K', t: 'pipes', x: 48, z: 8, len: 37, axis: 'z', y: 2.1 },
  { room: 'K', t: 'poster', x: 45.98 + 0.04, z: 14, r: 1, kind: 2 },
  { room: 'K', t: 'poster', x: 46.02, z: 33, r: 1, kind: 0 },
  { room: 'K', t: 'crate', x: 46.5, z: 43.6, s: 0.8 },
  { room: 'K', t: 'decal', x: 47, z: 24, kind: 'blood', s: 1.5 },
  { room: 'K', t: 'hazardFloor', x: 46, z: 8.1, w: 2, d: 0.25 },
  { room: 'K', t: 'sign', x: 47, z: 8.02, y: 2.3, text: 'ARRAY ACCESS', r: 0, red: true },
  ...
  // ---------- N: Quiet room 2 ----------
  { room: 'N', t: 'saveTerminal', x: 51.5, z: 36.35, r: 0 },
  { room: 'N', t: 'trunk', x: 49.8, z: 36.7, r: 0 },
...
// Interactive fixtures (beyond pickups and doors).
export const FIXTURES = [
  ...
  { id: 'f_save_C', room: 'C', x: 10, z: 20.9, r: 1.0, kind: 'save' },
  { id: 'f_box_C', room: 'C', x: 8.1, z: 21.2, r: 0.9, kind: 'box' },
  ...
  { id: 'f_save_N', room: 'N', x: 51.5, z: 36.9, r: 1.0, kind: 'save' },
  { id: 'f_box_N', room: 'N', x: 49.8, z: 37.2, r: 0.9, kind: 'box' },
